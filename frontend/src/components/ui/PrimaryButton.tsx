...
const PrimaryButton:React.FC<PrimaryButtonProps> = ({label,mode='dark',block,icon,loading}) => {
  ...
  return (
    <TouchableOpacity style={[layout.center,spacing.pdDefault,common.rounded,mode=='dark'?colors.backgroundPrimary:[colors.backgroundSurface,common.borderXsm,colors.outline],layout.flexRow,spacing.gapDefault,layout.itemsCenter, block?layout.widthFull:{alignSelf:'flex-start'} ]}>
